...
const stackFeatures = [
  {
    ...
    desc: 'Interpreta automáticamente escalas validadas, detecta banderas rojas y guía cada evaluación con rigor científico. Escalas EVA, PSFS, Barthel, GROC y más.',
    tags: ['EVA · PSFS · Barthel', 'Banderas rojas', 'Algoritmo de dolor', 'Anamnesis 14 págs.'],
    icon: Brain,
  ...
  },
  {
    ...
    title: 'Agenda + recordatorios automáticos',
    desc: 'Gestiona citas, recordatorios por WhatsApp y bloqueo de horarios. Vista semanal y mensual con optimización automática de la agenda del centro.',
    tags: ['Recordatorios WhatsApp', 'Vista semanal/mensual', 'Multi-kinesiólogo', 'Bloqueos automáticos'],
    icon: CalendarCheck,
  ...
  },
  {
    ...
    desc: 'Sesiones, evolución diaria, prescripciones e informes automáticos en un solo lugar. Acceso seguro desde cualquier dispositivo.',
    tags: ['Sesiones y evolución', 'Prescripciones', 'Informes automáticos', 'Multi-dispositivo'],
    icon: FileText,
    imageSrc: '/software/Panel.jpg',
  ...
  },
  {
    number: '05',
    label: 'Monitoreo',
    title: 'Panel de outcomes en tiempo real',
    desc: 'Visualización de evolución de pacientes, métricas de adherencia y gráficos de resultados clínicos. Toma decisiones informadas en cada sesión.',
    tags: ['Outcomes clínicos', 'Adherencia', 'Gráficos de evolución', 'Exportar informes'],
    icon: BarChart3,
    imageSrc: '/software/DSS.jpg',
